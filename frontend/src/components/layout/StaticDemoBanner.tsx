  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-2.5 flex items-center gap-3 text-sm">
        <Info className="w-4 h-4 flex-shrink-0 text-amber-600 dark:text-amber-300" aria-hidden="true" />
        <p className="flex-1 leading-snug">
          ...
          {snapshotDate && (
            <span className="hidden sm:inline-flex items-center gap-1 ml-2 text-amber-800/90 dark:text-amber-200/90">
        ...
        <div className="hidden sm:flex items-center gap-3 flex-shrink-0">
          <a
            ...
            className="inline-flex items-center gap-1.5 text-amber-800 hover:text-amber-900 dark:text-amber-200 dark:hover:text-amber-100 font-medium underline underline-offset-2"
          >
