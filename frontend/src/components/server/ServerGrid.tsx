  ...
  if (loading) {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {[...Array(8)].map((_, idx) => (
          <div key={idx} className="bg-card rounded-xl p-6 shadow-sm border border-border animate-pulse">
  ...
  if (servers.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-muted-foreground">Try adjusting filters or searching for other keywords</p>
      </div>
    );
  }
