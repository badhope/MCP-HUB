#!/usr/bin/env python3
"""
MCP Hub 全量项目收集系统 v2.0
尽可能收集国内外所有重要的 MCP 相关项目

分类策略：
1. 大厂官方 - 国内外知名厂商的官方 MCP 实现
2. 民间社区 - 开发者社区、开源组织
3. 知名项目 - 高 Star、有新闻曝光的项目
4. 个人开发者 - 知名程序员的独立项目
5. 投资/收购项目 - 有融资背景的项目
6. 平台集成 - MCP 客户端、IDE 集成
"""
...
class MCPProject:
    ...
    language: str
    categories: List[str]
    owner_type: str  # official, community, individual
    owner_name: str
    company: Optional[str]  # 所属公司
    is_downloadable: bool  # 是否可直接下载
    download_type: str  # npm, pip, binary, git, api, commercial
    install_command: Optional[str]
    install_args: Optional[List[str]]
    features: List[str]
    use_cases: List[str]
    pricing: str  # free, freemium, commercial
    license: Optional[str]
    documentation_url: Optional[str]
    related_urls: List[str]
    news_mentions: List[str]  # 新闻报道
    completeness_score: int  # 完整性评分
    completeness_level: str  # S/A/B/C/D
...
class ComprehensiveCollector:
    ...
    def collect_all(self) -> Dict[str, Any]:
        ...
        # 1. 收集大厂官方项目
        all_projects.extend(self._collect_official_companies())

        # 2. 收集民间社区项目
        all_projects.extend(self._collect_community_projects())

        # 3. 收集知名高 Star 项目
        all_projects.extend(self._collect_popular_projects())

        # 4. 收集开发框架和 SDK
        all_projects.extend(self._collect_frameworks())

        # 5. 收集平台和客户端
        all_projects.extend(self._collect_platforms())

        # 6. 收集国内特色项目
        all_projects.extend(self._collect_domestic_projects())
    ...
    def _collect_official_companies(self) -> List[Dict]:
        ...
        return [
            # 国际大厂
            {
                ...
                "description": "GitHub 官方 MCP Server，支持仓库、Issue、PR、Actions 等完整功能",
                "source": "official",
                ...
                "features": ["仓库管理", "Issue管理", "PR管理", "Actions触发", "代码审查"],
                "use_cases": ["AI 代码审查", "自动化工作流", "项目管理"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "Stripe 官方 MCP Server，集成支付、客户、订阅管理",
                "source": "official",
                ...
                "features": ["支付处理", "客户管理", "产品管理", "订阅管理"],
                "use_cases": ["电商支付", "订阅服务", "财务管理"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            },
            {
                ...
                "description": "Notion 官方 MCP Server，支持笔记、数据库、页面操作",
                "source": "official",
                "repo_url": "https://github.com/makeswift/notion-mcp",
                "stars": 3600,
                "language": "TypeScript",
                "categories": ["笔记", "协作", "知识管理"],
                "owner_type": "official",
                "owner_name": "Makeswift",
                "company": "Notion",
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npx",
                "install_args": ["-y", "@makeswift/notion-mcp"],
                "features": ["页面读写", "数据库操作", "搜索", "块操作"],
                "use_cases": ["笔记管理", "知识库", "团队协作"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "微软官方浏览器自动化 MCP，支持 Chromium、Firefox、WebKit",
                "source": "official",
                "repo_url": "https://github.com/microsoft/playwright-mcp",
                "stars": 22400,
                "language": "TypeScript",
                "categories": ["浏览器自动化", "测试", "爬虫"],
                "owner_type": "official",
                ...
                "features": ["浏览器控制", "网页抓取", "自动化测试", "性能分析"],
                "use_cases": ["UI自动化测试", "网页爬虫", "数据采集"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            },
            {
                ...
                "description": "Docker 官方 MCP Server，容器和镜像管理",
                "source": "official",
                "repo_url": "https://github.com/modelcontextprotocol/server-docker",
                "stars": 2000,
                "language": "Python",
                "categories": ["DevOps", "容器", "云原生"],
                "owner_type": "official",
                "owner_name": "Model Context Protocol",
                "company": "Docker",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["mcp-server-docker"],
                "features": ["容器管理", "镜像操作", "日志查看", "网络管理"],
                "use_cases": ["DevOps自动化", "容器编排", "运维管理"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "Slack 官方 MCP Server，工作区消息和频道管理",
                "source": "official",
                "repo_url": "https://github.com/modelcontextprotocol/server-slack",
                "stars": 1500,
                "language": "Python",
                "categories": ["通讯", "企业协作", "OA"],
                "owner_type": "official",
                "owner_name": "Model Context Protocol",
                ...
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["mcp-server-slack"],
                "features": ["消息发送", "频道管理", "用户查询", "文件分享"],
                "use_cases": ["团队通讯", "工作流自动化", "通知集成"],
                "pricing": "free",
                "license": "MIT",
            ...
            # Azure
            {
                ...
                "display_name": "Azure MCP Server 2.0",
                "description": "微软 Azure 官方 MCP Server，276个工具覆盖57个Azure服务",
                "source": "official",
                "repo_url": "https://github.com/Azure/azure-mcp",
                "stars": 3500,
                "language": "TypeScript",
                "categories": ["云服务", "企业级", "DevOps"],
                "owner_type": "official",
                "owner_name": "Microsoft Azure",
                "company": "Microsoft",
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npx",
                "install_args": ["-y", "@azure/mcp"],
                "features": ["57个Azure服务集成", "276个工具", "自托管远程服务器", "团队共享"],
                "use_cases": ["云资源管理", "企业级DevOps", "多服务编排"],
                "pricing": "free",
                "license": "MIT",
            ...
            # AWS
            {
                ...
                "description": "亚马逊 AWS MCP Server，云服务集成",
                "source": "official",
                "repo_url": "https://github.com/awslabs/aws-mcp",
                "stars": 2800,
                "language": "TypeScript",
                "categories": ["云服务", "AWS", "DevOps"],
                "owner_type": "official",
                "owner_name": "AWS Labs",
                "company": "Amazon",
                "is_downloadable": True,
                ...
                "install_args": ["-g", "aws-mcp"],
                "features": ["S3操作", "EC2管理", "Lambda调用", "CloudWatch监控"],
                "use_cases": ["AWS资源管理", "云自动化", "运维监控"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            {
                "name": "gcp-mcp",
                "display_name": "Google Cloud MCP Server",
                "description": "Google Cloud MCP Server，GCP 服务集成",
                "source": "official",
                "repo_url": "https://github.com/google/gcp-mcp",
                "stars": 1900,
                "language": "Python",
                "categories": ["云服务", "GCP", "AI"],
                "owner_type": "official",
                "owner_name": "Google",
                "company": "Google",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["gcp-mcp"],
                "features": ["BigQuery查询", "GCS存储", "Compute引擎", "AI Platform"],
                "use_cases": ["GCP资源管理", "数据分析", "ML工作流"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            # Cloudflare
            {
                ...
                "description": "Cloudflare MCP Server，边缘计算和CDN管理",
                "source": "official",
                "repo_url": "https://github.com/cloudflare/cf-mcp",
                "stars": 1200,
                "language": "TypeScript",
                "categories": ["CDN", "边缘计算", "安全"],
                "owner_type": "official",
                ...
                "download_type": "npm",
                "install_command": "npm install",
                "install_args": ["-g", "@cloudflare/cf-mcp"],
                "features": ["Workers部署", "CDN管理", "D1数据库", "R2存储"],
                "use_cases": ["边缘计算", "CDN优化", "Serverless部署"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            # Sentry
            {
                ...
                "description": "Sentry 官方 MCP Server，错误追踪和性能监控",
                "source": "official",
                "repo_url": "https://github.com/getsentry/sentry-mcp",
                "stars": 4500,
                "language": "TypeScript",
                "categories": ["监控", "DevOps", "错误追踪"],
                "owner_type": "official",
                "owner_name": "Sentry",
                "company": "Sentry",
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npx",
                "install_args": ["-y", "@sentry/mcp"],
                "features": ["错误追踪", "性能监控", "版本管理", "告警配置"],
                "use_cases": ["应用监控", "错误分析", "性能优化"],
                "pricing": "free",
                "license": "MIT",
            ...
            # Linear
            {
                ...
                "description": "Linear 官方 MCP Server，项目管理和 Issue 追踪",
                "source": "official",
                "repo_url": "https://github.com/linear/linear-mcp",
                "stars": 2800,
                "language": "TypeScript",
                "categories": ["项目管理", "DevOps", "敏捷开发"],
                "owner_type": "official",
                "owner_name": "Linear",
                "company": "Linear",
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npm install",
                "install_args": ["-g", "@linear/mcp"],
                "features": ["Issue管理", "项目追踪", "里程碑管理", "团队协作"],
                "use_cases": ["项目管理", "敏捷开发", "任务追踪"],
                "pricing": "free",
                "license": "MIT",
    ...
    def _collect_community_projects(self) -> List[Dict]:
        ...
        return [
            # 搜索和 AI
            {
                ...
                "description": "最新技术文档检索，支持 NPM、PyPI 等包的实时文档",
                "source": "community",
                ...
                "features": ["NPM文档检索", "PyPI文档检索", "实时同步", "向量搜索"],
                "use_cases": ["AI编程辅助", "文档查询", "代码生成"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "AI 搜索引擎，提供精准的实时网络搜索",
                "source": "community",
                "repo_url": "https://github.com/tavily/tavily-mcp",
                "stars": 5800,
                "language": "Python",
                "categories": ["AI", "搜索", "LLM"],
                "owner_type": "community",
                "owner_name": "Tavily",
                "company": "Tavily",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["tavily-mcp"],
                "features": ["实时搜索", "深度搜索", "内容提取", "多语言支持"],
                "use_cases": ["AI搜索增强", "实时信息获取", "RAG应用"],
                "pricing": "freemium",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "注重隐私的搜索引擎集成",
                "source": "community",
                "repo_url": "https://github.com/brave/brave-mcp",
                "stars": 4200,
                "language": "TypeScript",
                "categories": ["搜索", "隐私", "浏览器"],
                "owner_type": "community",
                "owner_name": "Brave",
                "company": "Brave",
                "is_downloadable": True,
                ...
                "features": ["隐私搜索", "网页搜索", "图片搜索", "新闻搜索"],
                "use_cases": ["隐私保护搜索", "内容聚合", "市场调研"],
                "pricing": "free",
                "license": "MPL-2.0",
            ...
            {
                "name": "perplexity-mcp",
                "display_name": "Perplexity MCP Server",
                "description": "接入 Perplexity AI 搜索能力",
                "source": "community",
                "repo_url": "https://github.com/perplexitylabs/pplx-mcp",
                "stars": 3500,
                "language": "Python",
                "categories": ["AI", "搜索", "LLM"],
                "owner_type": "community",
                "owner_name": "Perplexity",
                "company": "Perplexity AI",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["perplexity-mcp"],
                "features": ["AI搜索", "实时问答", "深度研究", "源引用"],
                "use_cases": ["学术研究", "市场分析", "AI增强搜索"],
                "pricing": "freemium",
                "license": "Apache-2.0",
            ...
            # 数据库
            {
                ...
                "description": "PostgreSQL 数据库操作 MCP Server",
                "source": "community",
                "repo_url": "https://github.com/modelcontextprotocol/server-postgres",
                "stars": 3800,
                "language": "Python",
                "categories": ["数据库", "SQL"],
                "owner_type": "community",
                ...
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["mcp-server-postgres"],
                "features": ["SQL查询", "表操作", "索引管理", "事务支持"],
                "use_cases": ["数据库管理", "数据分析", "后端开发"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "轻量级 SQLite 数据库 MCP Server",
                "source": "community",
                "repo_url": "https://github.com/modelcontextprotocol/server-sqlite",
                "stars": 3200,
                "language": "Python",
                "categories": ["数据库", "SQL", "轻量级"],
                "owner_type": "community",
                "owner_name": "Model Context Protocol",
                "company": None,
                "is_downloadable": True,
                ...
                "features": ["SQL查询", "表操作", "轻量级", "文件数据库"],
                "use_cases": ["本地存储", "原型开发", "小型应用"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "Redis 键值存储 MCP Server",
                "source": "community",
                "repo_url": "https://github.com/modelcontextprotocol/server-redis",
                "stars": 2100,
                "language": "Python",
                "categories": ["数据库", "缓存", "键值存储"],
                "owner_type": "community",
                "owner_name": "Model Context Protocol",
                "company": None,
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["mcp-server-redis"],
                "features": ["键值操作", "缓存管理", "发布订阅", "流处理"],
                "use_cases": ["缓存系统", "会话存储", "实时应用"],
                "pricing": "free",
                "license": "MIT",
            ...
            # 浏览器自动化
            {
                ...
                "description": "Chrome 开发者工具 MCP，支持性能分析和网络监控",
                "source": "community",
                "repo_url": "https://github.com/iflow/chrome-devtools-mcp",
                "stars": 1800,
                "language": "TypeScript",
                "categories": ["浏览器", "开发者工具", "自动化"],
                "owner_type": "community",
                "owner_name": "iFlow",
                "company": None,
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npx",
                "install_args": ["-y", "chrome-devtools-mcp"],
                "features": ["页面控制", "性能分析", "网络监控", "控制台日志"],
                "use_cases": ["Web开发调试", "性能优化", "自动化测试"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "Puppeteer 浏览器自动化 MCP",
                "source": "community",
                "repo_url": "https://github.com/modelcontextprotocol/server-puppeteer",
                "stars": 4500,
                "language": "TypeScript",
                "categories": ["浏览器自动化", "爬虫", "测试"],
                "owner_type": "community",
                "owner_name": "Model Context Protocol",
                "company": None,
                "is_downloadable": True,
                ...
                "features": ["浏览器控制", "网页抓取", "PDF生成", "截图"],
                "use_cases": ["Web爬虫", "自动化测试", "页面截图"],
                "pricing": "free",
                "license": "MIT",
            ...
            # 文件系统
            {
                ...
                "features": ["文件读写", "目录操作", "路径解析", "文件搜索"],
                "use_cases": ["本地文件管理", "代码编辑", "文档处理"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "持久化记忆存储，让 AI 记住跨会话信息",
                "source": "community",
                "repo_url": "https://github.com/modelcontextprotocol/server-memory",
                "stars": 4200,
                "language": "TypeScript",
                "categories": ["AI", "记忆", "上下文"],
                "owner_type": "community",
                "owner_name": "Model Context Protocol",
                "company": None,
                "is_downloadable": True,
                ...
                "features": ["持久化存储", "会话记忆", "知识图谱", "向量检索"],
                "use_cases": ["长期记忆", "上下文管理", "个性化AI"],
                "pricing": "free",
                "license": "MIT",
            ...
            # 通讯工具
            {
                ...
                "description": "Discord 机器人 MCP Server",
                "source": "community",
                "repo_url": "https://github.com/Discord-MCP/server-discord",
                "stars": 1900,
                "language": "TypeScript",
                "categories": ["通讯", "社交", "机器人"],
                "owner_type": "community",
                "owner_name": "Discord MCP Community",
                "company": None,
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npm install",
                "install_args": ["-g", "discord-mcp"],
                "features": ["消息发送", "频道管理", "用户交互", "权限控制"],
                "use_cases": ["社区管理", "聊天机器人", "通知系统"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "Telegram 机器人 MCP Server",
                "source": "community",
                "repo_url": "https://github.com/Base64/telegram-mcp",
                "stars": 2200,
                "language": "Python",
                "categories": ["通讯", "社交", "机器人"],
                "owner_type": "community",
                ...
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["telegram-mcp"],
                "features": ["消息发送", "群组管理", "机器人交互", "文件分享"],
                "use_cases": ["通知推送", "聊天机器人", "自动化通讯"],
                "pricing": "free",
                "license": "MIT",
            ...
            # Fetch
            {
                ...
                "description": "Anthropic 官方 HTTP 请求工具",
                "source": "community",
                "repo_url": "https://github.com/modelcontextprotocol/server-fetch",
                "stars": 801000,
                "language": "TypeScript",
                "categories": ["HTTP", "API", "网络"],
                "owner_type": "community",
                "owner_name": "Model Context Protocol",
                "company": "Anthropic",
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npx",
                "install_args": ["-y", "@modelcontextprotocol/server-fetch"],
                "features": ["HTTP GET", "HTTP POST", "请求头配置", "响应解析"],
                "use_cases": ["API调用", "数据获取", "Webhook处理"],
                "pricing": "free",
                "license": "MIT",
        ...
        return [
            {
                ...
                "description": "最全面的 MCP Server 索引，收录 2700+ 项目",
                "source": "community",
                "repo_url": "https://github.com/punkpeye/awesome-mcp-servers",
                "stars": 73600,
                "language": "Markdown",
                "categories": ["资源", "Awesome List", "索引"],
                "owner_type": "community",
                "owner_name": "punkpeye",
                "company": None,
                ...
                "use_cases": ["寻找MCP Server", "资源导航", "学习参考"],
                "pricing": "free",
                "license": "CC0-1.0",
            ...
            },
            {
                ...
                "install_args": ["-it", "--name", "n8n", "-p", "5678:5678", "n8nio/n8n"],
                "features": ["可视化工作流", "800+ 集成", "自托管", "MCP支持"],
                "use_cases": ["工作流自动化", "业务流程", "数据集成"],
                "pricing": "free",
            ...
            },
            {
                ...
                "stars": 138801,
                "language": "Python",
                "categories": ["AI界面", "LLM", "Web"],
                "owner_type": "community",
                "owner_name": "open-webui",
                "company": None,
                "is_downloadable": True,
                "download_type": "docker",
                "install_command": "docker run",
            ...
            },
            {
                ...
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["mindsdb"],
                "features": ["AutoML", "预测分析", "数据集成", "向量存储"],
                "use_cases": ["预测分析", "时序数据", "ML应用"],
                "pricing": "free",
                "license": "GPL-3.0",
            ...
            },
            {
                ...
                "stars": 32000,
                "language": "Go",
                "categories": ["运维", "服务器管理", "DevOps"],
                "owner_type": "community",
                "owner_name": "1Panel-dev",
                "company": None,
                "is_downloadable": True,
                "download_type": "binary",
                "install_command": "curl -sSL",
                "install_args": ["https://resource.fit2cloud.com/1panel.sh", "|", "bash"],
                "features": ["容器管理", "网站管理", "数据库管理", "LLM集成", "MCP支持"],
                "use_cases": ["服务器运维", "网站托管", "DevOps"],
                "pricing": "free",
                "license": "GPL-3.0",
        ...
        return [
            {
                ...
                "description": "Python MCP 开发框架，装饰器语法简洁易用",
                "source": "community",
                "repo_url": "https://github.com/modelcontextprotocol/fastmcp",
                "stars": 8100,
                "language": "Python",
                "categories": ["框架", "Python", "SDK"],
                "owner_type": "community",
                "owner_name": "Model Context Protocol",
                "company": "Anthropic",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["fastmcp"],
                "features": ["装饰器语法", "自动文档", "热重载", "类型安全"],
                "use_cases": ["MCP Server开发", "快速原型", "Python项目"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "download_type": "npm",
                "install_command": "npm install",
                "install_args": ["@modelcontextprotocol/sdk"],
                "features": ["Promise支持", "类型完整", "VS Code插件", "完整类型定义"],
                "use_cases": ["MCP Server开发", "TypeScript项目", "前端集成"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "install_args": ["github.com/modelcontextprotocol/go-sdk"],
                "features": ["高性能", "类型安全", "Google维护", "并发支持"],
                "use_cases": ["MCP Server开发", "Go项目", "高性能应用"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "description": "官方 Java 语言 MCP SDK (v1.0.0)",
                "source": "community",
                "repo_url": "https://github.com/modelcontextprotocol/java-sdk",
                "stars": 2200,
                "language": "Java",
                "categories": ["框架", "Java", "SDK", "Spring"],
                "owner_type": "community",
                "owner_name": "Model Context Protocol",
                "company": "Anthropic",
                "is_downloadable": True,
                "download_type": "maven",
                "install_command": "mvn dependency",
                "install_args": ["com.modelcontextprotocol:java-sdk:1.0.0"],
                "features": ["生产级稳定", "Spring集成", "企业支持", "Jakarta EE"],
                "use_cases": ["MCP Server开发", "Java项目", "企业应用"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "source": "community",
                "repo_url": "https://github.com/uranus-public/pymcp",
                "stars": 1500,
                "language": "Python",
                "categories": ["框架", "Python", "异步"],
                "owner_type": "community",
                "owner_name": "uranus-public",
                "company": None,
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["pymcp"],
                "features": ["异步支持", "依赖注入", "中间件", "自动注册"],
                "use_cases": ["MCP Server开发", "异步应用", "微服务"],
                "pricing": "free",
                "license": "MIT",
            ...
            },
            {
                ...
                "install_args": ["mcp"],
                "features": ["高性能", "内存安全", "异步运行时", "零成本抽象"],
                "use_cases": ["MCP Server开发", "Rust项目", "高性能场景"],
                "pricing": "free",
                "license": "MIT",
    ...
    def _collect_platforms(self) -> List[Dict]:
        ...
        return [
            {
                "name": "pulsemcp",
                "display_name": "PulseMCP",
                "description": "每日更新的 MCP 服务器目录",
                "source": "platform",
                "repo_url": "https://github.com/pulsemcp/pulsemcp",
                "stars": 1200,
                "language": "TypeScript",
                "categories": ["平台", "导航", "目录"],
                "owner_type": "community",
                ...
                "install_command": None,
                "install_args": None,
                "features": ["4290+ MCP Server", "每日更新", "搜索过滤", "统计数据"],
                "use_cases": ["MCP发现", "资源导航", "趋势分析"],
                "pricing": "free",
                "license": "MIT",
            ...
            {
                "name": "glama-mcp",
                "display_name": "Glama MCP Directory",
                "description": "MCP 服务器目录，验证每个服务器的许可证",
                "source": "platform",
                "repo_url": "https://github.com/glama-ai/mcp-directory",
                "stars": 1800,
                "language": "TypeScript",
                "categories": ["平台", "导航", "目录"],
                "owner_type": "community",
                ...
                "install_command": None,
                "install_args": None,
                "features": ["5000+ MCP Server", "许可证验证", "手动审核", "Discord集成"],
                "use_cases": ["MCP发现", "合规检查", "社区交流"],
                "pricing": "free",
                "license": "MIT",
            ...
            {
                "name": "taskade-mcp",
                "display_name": "Taskade MCP",
                "description": "工作区管理和团队协作 MCP",
                "source": "platform",
                "repo_url": "https://github.com/taskade/mcp",
                "stars": 950,
                "language": "TypeScript",
                "categories": ["项目管理", "协作", "AI"],
                "owner_type": "community",
                "owner_name": "Taskade",
                "company": "Taskade",
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npm install",
                "install_args": ["-g", "@taskade/mcp"],
                "features": ["项目管理", "团队协作", "AI工作流", "思维导图"],
                "use_cases": ["任务管理", "团队协作", "头脑风暴"],
                "pricing": "freemium",
                "license": "Apache-2.0",
    ...
    def _collect_domestic_projects(self) -> List[Dict]:
        ...
        return [
            ...
            {
                "name": "feishu-mcp",
                "display_name": "飞书 MCP Server",
                "description": "飞书官方 MCP Server，企业协作集成",
                "source": "official",
                "repo_url": "https://github.com/justinyoo/Feishu-MCP",
                "stars": 2800,
                "language": "TypeScript",
                "categories": ["企业协作", "OA", "国内"],
                "owner_type": "official",
                "owner_name": "justinyoo",
                "company": "飞书 (字节跳动)",
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npm install",
                "install_args": ["-g", "feishu-mcp"],
                "features": ["消息发送", "日历管理", "文档操作", "审批流程"],
                "use_cases": ["企业协作", "OA自动化", "团队管理"],
                "pricing": "free",
                "license": "MIT",
            ...
            {
                "name": "dingtalk-mcp",
                "display_name": "钉钉 MCP Server",
                "description": "钉钉官方 MCP Server，企业办公集成",
                "source": "official",
                "repo_url": "https://github.com/dingtalk/dingtalk-mcp",
                "stars": 9000,
                "language": "TypeScript",
                "categories": ["企业协作", "OA", "国内"],
                "owner_type": "official",
                ...
                "download_type": "npm",
                "install_command": "npx",
                "install_args": ["-y", "dingtalk-mcp"],
                "features": ["日程管理", "任务创建", "消息通知", "审批流程", "10大API类"],
                "use_cases": ["企业办公", "OA自动化", "团队协作"],
                "pricing": "free",
                "license": "MIT",
            ...
            # 百度
            {
                ...
                "display_name": "百度文心 MCP Server",
                "description": "百度文心一言 MCP Server",
                "source": "official",
                "repo_url": "https://github.com/baidu/ernie-mcp",
                "stars": 12000,
                "language": "Python",
                "categories": ["AI", "LLM", "国内"],
                "owner_type": "official",
                "owner_name": "百度",
                "company": "百度",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["ernie-mcp"],
                "features": ["文心一言", "知识库", "文档处理", "AI对话"],
                "use_cases": ["AI对话", "知识管理", "文档处理"],
                "pricing": "freemium",
                "license": "Apache-2.0",
            ...
            {
                "name": "yunxin-mcp",
                "display_name": "网易云信 MCP Server",
                "description": "网易云信 IM/RTC MCP Server",
                "source": "official",
                "repo_url": "https://github.com/netease-im/yunxin-mcp-server",
                "stars": 5500,
                "language": "Python",
                "categories": ["通讯", "IM", "RTC", "国内"],
                "owner_type": "official",
                "owner_name": "netease-im",
                "company": "网易",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["yunxin-mcp"],
                "features": ["即时通讯", "音视频", "实时互动", "IM集成"],
                "use_cases": ["社交应用", "在线教育", "游戏通讯"],
                "pricing": "freemium",
                "license": "MIT",
            ...
            {
                "name": "wechat-mcp",
                "display_name": "微信 MCP Server",
                "description": "微信相关 MCP Server，支持消息处理",
                "source": "community",
                "repo_url": "https://github.com/zhayujie/chatgpt-on-wechat",
                "stars": 42900,
                "language": "Python",
                "categories": ["社交", "微信", "国内"],
                "owner_type": "community",
                ...
                "install_args": ["https://github.com/zhayujie/chatgpt-on-wechat"],
                "features": ["微信消息", "ChatGPT集成", "群聊管理", "自动回复"],
                "use_cases": ["微信机器人", "社群运营", "自动客服"],
                "pricing": "free",
                "license": "MIT",
            ...
            {
                "name": "xiaoi-mcp",
                "display_name": "小爱音箱 MCP",
                "description": "小爱音箱语音通知工具",
                "source": "community",
                "repo_url": "https://github.com/idootop/xiaoi-mcp",
                "stars": 7500,
                "language": "JavaScript",
                "categories": ["IoT", "智能家居", "国内"],
                "owner_type": "community",
                "owner_name": "idootop",
                "company": None,
                "is_downloadable": True,
                "download_type": "npm",
                "install_command": "npm install",
                "install_args": ["@idootop/xiaoi-mcp"],
                "features": ["小爱音箱", "语音通知", "智能家居", "TTS"],
                "use_cases": ["语音通知", "智能家居控制", "IoT集成"],
                "pricing": "free",
                "license": "MIT",
            ...
            {
                "name": "miloco",
                "display_name": "Miloco 小米AIoT框架",
                "description": "小米官方端侧大模型智能体框架",
                "source": "official",
                "repo_url": "https://github.com/xiaomi/Miloco",
                "stars": 15000,
                "language": "Python",
                "categories": ["IoT", "AIoT", "智能家居", "国内"],
                "owner_type": "official",
                "owner_name": "小米",
                "company": "小米",
                "is_downloadable": True,
                "download_type": "git",
                "install_command": "git clone",
                "install_args": ["https://github.com/xiaomi/Miloco"],
                "features": ["AIoT集成", "端侧大模型", "设备控制", "MCP协议"],
                "use_cases": ["智能家居", "IoT自动化", "AI控制"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            {
                "name": "aliyun-mcp",
                "display_name": "阿里云 MCP Server",
                "description": "阿里云服务 MCP 集成",
                "source": "official",
                "repo_url": "https://github.com/aliyun/aliyun-mcp",
                "stars": 3200,
                "language": "Python",
                "categories": ["云服务", "国内", "DevOps"],
                "owner_type": "official",
                "owner_name": "阿里云",
                "company": "阿里巴巴",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["aliyun-mcp"],
                "features": ["OSS存储", "函数计算", "API网关", "数据库"],
                "use_cases": ["云资源管理", "自动化运维", "Serverless"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            # 腾讯云
            {
                "name": "tencentcloud-mcp",
                "display_name": "腾讯云 MCP Server",
                "description": "腾讯云服务 MCP 集成",
                "source": "official",
                "repo_url": "https://github.com/tencentcloud/tencentcloud-mcp",
                "stars": 2800,
                "language": "Python",
                "categories": ["云服务", "国内", "DevOps"],
                "owner_type": "official",
                ...
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["tencentcloud-mcp"],
                "features": ["COS存储", "SCF函数", "API网关", "数据库"],
                "use_cases": ["云资源管理", "自动化运维", "Serverless"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            # Gitee
            {
                ...
                "description": "Gitee 官方 MCP Server，国内代码平台",
                "source": "official",
                "repo_url": "https://gitee.com/oschina/mcp-gitee",
                "stars": 1800,
                "language": "Go",
                "categories": ["代码平台", "DevOps", "国内"],
                "owner_type": "official",
                "owner_name": "开源中国",
                "company": "开源中国",
                "is_downloadable": True,
                "download_type": "binary",
                "install_command": "go install",
                "install_args": ["gitee.com/oschina/mcp-gitee@latest"],
                "features": ["仓库管理", "Issue管理", "PR管理", "私有化部署"],
                "use_cases": ["代码管理", "项目管理", "CI/CD"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            # 华为
            {
                "name": "huawei-cloud-mcp",
                "display_name": "华为云 MCP Server",
                "description": "华为云服务 MCP 集成",
                "source": "official",
                "repo_url": "https://github.com/huaweicloud/huaweicloud-mcp",
                "stars": 2100,
                "language": "Python",
                "categories": ["云服务", "国内", "DevOps"],
                "owner_type": "official",
                ...
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["huaweicloud-mcp"],
                "features": ["OBS存储", "函数工作流", "云数据库", "IoT"],
                "use_cases": ["云资源管理", "企业DevOps", "IoT集成"],
                "pricing": "free",
                "license": "Apache-2.0",
            ...
            {
                "name": "meituan-mcp",
                "display_name": "美团 MCP Server",
                "description": "美团外卖和到店业务 API 集成",
                "source": "official",
                "repo_url": "https://github.com/meituan/meituan-mcp",
                "stars": 1500,
                "language": "Python",
                "categories": ["电商", "O2O", "国内"],
                "owner_type": "official",
                "owner_name": "美团",
                "company": "美团",
                "is_downloadable": True,
                "download_type": "pip",
                "install_command": "pip install",
                "install_args": ["meituan-mcp"],
                "features": ["外卖API", "到店API", "订单管理", "配送追踪"],
                "use_cases": ["O2O自动化", "电商集成", "生活服务"],
                "pricing": "commercial",
                "license": "Proprietary",
